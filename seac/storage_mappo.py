...
class RolloutStorage(object):
    def __init__(
        ...
        if action_space[0].__class__.__name__ == "Discrete":
            ...
            action_shape = action_space[0].shape[0]
    ...
    def feed_forward_generator(
        ...
        for indices in sampler:
            ...
            yield obs_batch, actions_batch, value_preds_batch, return_batch, masks_batch, adv_targ
    ...
    def recurrent_generator(self, advantages, num_mini_batch):
        ...
        for start_ind in range(0, num_processes, num_envs_per_batch):
            ...
            yield obs_batch, actions_batch, return_batch, masks_batch, adv_targ
