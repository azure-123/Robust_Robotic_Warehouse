...
def main(
    ...
    adv_value, tar_action, adv_action_log_prob, adv_recurrent_hidden_staets = zip(
                    *[
                        agent.model.act(
                            obs[agent.agent_id],
                            agent.storage.recurrent_hidden_states[0],
    ...
    adv_obs = tar_attack(agents[0].model, 0.1, obs, n_action, tar_action, agents[0].optimizer)
